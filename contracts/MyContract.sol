...
contract Agrinsure is ChainlinkClient, DateTime{
    ...
    function newPolicy (uint _area, string _location, uint8 _forFlood, uint8 _cropId) external payable{
    ...
    function getPremiumAmount(uint _policyId) public constant returns(uint){
    ...
    function makeRequest(string _location, string _date) internal returns (bytes32 requestId)
    {
        ...
        //req.add("key", "4ac1129adfc04b67b3e134749202005");
    ...
    recordChainlinkFulfillment(_requestId)
    {
        ...
        if(policies[claimPolicyId].forFlood==1)
        {
